...
{
    public class TableTreeDrawerColumnPropertyComparer : IComparer<SerializedProperty>
    {
        public static TableTreeDrawerColumnPropertyComparer Default { get; } = new TableTreeDrawerColumnPropertyComparer();
